...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if(PlayState.SONG.stage == null || PlayState.SONG.stage.length < 1) {
			switch (songName)
			{
				...
				case 'winter-horrorland':
					curStage = 'mallEvil';
				case 'senpai':
					curStage = 'deluxeschool';
				case 'roses':
					curStage = 'deluxeschoolmad';
				case 'thorns':
					curStage = 'deluxeschoolevil';
				default:
					curStage = 'stage';
			}
		}
		...
		switch (curStage)
		{
			...
			case 'deluxeschool': //Week 6 - Senpai
				var bg:BGSprite = new BGSprite('weebHD/schoolBg', -600, -200, 0.9, 0.9);
				add(bg);

				bgGirlsHD = new BGSprite('weebHD/bgGirlsHD', -150, 100, 0.9, 0.9);
				bgGirlsHD.animation.addByPrefix('bop', 'bgGirls bop', 12, false);
				bgGirlsHD.setGraphicSize(Std.int(bgGirlsHD.width * 1));
				bgGirlsHD.updateHitbox();
				add(bgGirlsHD);

			case 'deluxeschoolmad': //Week 6 - Roses
				var bg:BGSprite = new BGSprite('weebHD/schoolBgMad', -600, -200, 0.9, 0.9);
				add(bg);

			case 'deluxeschoolevil': //Week 6 - Thorns
				var bg:BGSprite = new BGSprite('weebHD/schoolBgEvil', -600, -200, 0.9, 0.9);
				add(bg);
				}
		}
